...
namespace HealthIQ.CommonLayer.AOPRegistrations
{
    public class UnityRegistration
    {
        ...
        {
            AopEngine.Container.RegisterType<IUserRepository, UserDataImpl>(
                GetPersistenceRegisterInstanceName(AspectEnums.PeristenceInstanceNames.UserDataImpl,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<ISecurityRepository, SecurityDataImpl>(
                GetPersistenceRegisterInstanceName(AspectEnums.PeristenceInstanceNames.SecurityDataImpl,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<IStudentRepository, StudentDataImpl>(
                GetPersistenceRegisterInstanceName(AspectEnums.PeristenceInstanceNames.StudentDataImpl,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<INotificationRepository, NotificationDataImpl>(
                GetPersistenceRegisterInstanceName(AspectEnums.PeristenceInstanceNames.NotificationDataImpl,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<IAdminRepository, AdminDataImpl>(
                GetPersistenceRegisterInstanceName(AspectEnums.PeristenceInstanceNames.AdminDataImpl,
                    AspectEnums.ApplicationName.HealthIQ));
        }
        ...
        private static string GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames aspectName,
            AspectEnums.ApplicationName application)
        {
            return string.Format("{0}_{1}", application.ToString(), aspectName.ToString());
        }
        ...
        {
            AopEngine.Container.RegisterType<IUserService, UserManager>(
                GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames.UserManager,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<ISecurityService, SecurityManager>(
                GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames.SecurityManager,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<IStudentService, StudentManager>(
                GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames.StudentManager,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<INotificationService, NotificationManager>(
                GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames.NotificationManager,
                    AspectEnums.ApplicationName.HealthIQ));
            AopEngine.Container.RegisterType<IAdminService, AdminManager>(
                GetBusinessRegisterInstanceName(AspectEnums.AspectInstanceNames.AdminManager,
                    AspectEnums.ApplicationName.HealthIQ));
        }
        ...
        private static MapperConfiguration MapBOEntities()
        {
            var config = new MapperConfiguration(map =>
            {
                ...
                map.CreateMap<UserMaster, UserMasterDTO>()
                    ...
                    //.ForMember(d => d.RoleId, opt => opt.MapFrom(s => s.UserRoles.FirstOrDefault().RoleID))
                    .ForMember(d => d.IsAdmin,
                        opt => opt.MapFrom(s =>
                            s.UserRoles.FirstOrDefault().RoleID == (int)AspectEnums.RoleType.Admin));
